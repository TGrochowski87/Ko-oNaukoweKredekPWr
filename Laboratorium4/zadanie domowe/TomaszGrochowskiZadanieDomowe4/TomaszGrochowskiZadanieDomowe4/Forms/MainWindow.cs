...
namespace TomaszGrochowskiZadanieDomowe4.Forms
{
    ...
    public partial class MainWindow : Form
    {
        ...
        private void buttonAnimals_Click(object sender, EventArgs e)
        {
            ...
            dataGridViewShowData.DataSource = animalsRepository.GetAnimals();
        }
        ...
        private void buttonMushrooms_Click(object sender, EventArgs e)
        {
            ...
            //Filling DataGridView with adequate data
            dataGridViewShowData.DataSource = null;
            dataGridViewShowData.DataSource = mushroomsRepository.GetMushrooms();
        }
        ...
        private void buttonRegions_Click(object sender, EventArgs e)
        {
            ...
            //Filling DataGridView with adequate data
            dataGridViewShowData.DataSource = null;
            dataGridViewShowData.DataSource = regionsRepository.GetRegions();
        }
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            //Deleting selected keeper from data base
